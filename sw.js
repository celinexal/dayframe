const DAYFRAME_CACHE = 'dayframe-shell-v47';
...
const DAYFRAME_BUDGET_REDESIGN_SRC = '/assets/dayframe-budget-redesign.js?v=20260829-no-review-wording';
const DAYFRAME_BUDGET_FIXUPS_SRC = '/assets/dayframe-budget-fixups.js?v=20260829-no-review-budget-copy';
