const DAYFRAME_CACHE = 'dayframe-shell-v209';
...
const DAYFRAME_BILLS_PERSISTENCE_SRC = '/assets/dayframe-bills-persistence-fix.js?v=20260904-bill-due-grace-v2';
...
const DAYFRAME_VISUAL_TIDY_SRC = '/assets/dayframe-visual-tidy.js?v=20260904-hide-rent-bills-v4';
...
const DAYFRAME_LIFE_STAGE_SRC = '/assets/dayframe-life-stage.js?v=20260905-disabled-superseded-by-cleanup-v8';
const DAYFRAME_ESSENTIALS_SRC = '/assets/dayframe-essentials.js?v=20260831-essentials-customise-v20';
const DAYFRAME_ESSENTIALS_CLEANUP_SRC = '/assets/dayframe-essentials-cleanup.js?v=20260905-stop-myflo-flicker-v10';
const DAYFRAME_ESSENTIALS_CLICKFIX_SRC = '/assets/dayframe-essentials-clickfix.js?v=20260905-medication-reminders-v3';
const DAYFRAME_ESSENTIALS_CUSTOMISE_SRC = '/assets/dayframe-essentials-customise.js?v=20260905-disabled-superseded-by-bible-v1';
